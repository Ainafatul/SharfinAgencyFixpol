    ...
    <div style="padding-bottom: 100px;padding-top: 50px">
        <div class="card m-lg-auto">
            ...
            <div class="card-body" style="margin-bottom: 36px">
                <form class="m-lg-auto" action="/onUpdateAbout/{{ $about->id }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <input id="customFile" name="image" class="custom-file-input" type="file" value="{{ $about->image}}">
