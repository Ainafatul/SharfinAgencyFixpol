                                    ...
                                    <a href="{{route('AgentDetail',['id'=>$agent->id])}}" class="item-agen">
                                        <div class="row">
                                            <div class="col-12 col-sm-8 my-auto">
                                                <div class="row ">
                                                    <div class="col-4 col-sm-5 col-md-4 col-lg-3 my-auto text-center py-3 py-sm-0">
                                                        <img src="{{asset($agent->picture)}}" class="figure-img img-fluid img-agen icon-fitur">
                                                    </div>
                                                    <div class="col-8 col-sm-7 col-md-8 col-lg-9 my-auto  ">
                                                        <h5 class="card-subtitle mb-2 disingkat">{{$agent->name}}</h5>
                                                        <h6 class="card-subtitle small text-dark disingkat ">{{$agent->agency}}</h6><br>
                                                        <h6 class="card-subtitle disingkat ">{{count(\App\Property::where('agent',$agent->id)->get())}} Listing
                                                            Property</h6>
                                                    </div>
                                                </div>
                                            </div>
