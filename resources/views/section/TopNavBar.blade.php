<div class="page-content">
    <nav class="navbar navbar-expand-lg navbar-dark " style="background: #343A40">
        <a class="navbar-brand font-weight-bold text-center" style="width: 260px" href="/"><i class="fas fa-home"></i> Shafrin Agency</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            @if(!\Illuminate\Support\Facades\Auth::check())
                <a href="{{route('UserRegister')}}" class="btn btn-outline-light btn-sm rounded-pill mr-1 px-4">Register</a>
                <a href="{{route('SignIn')}}" class="btn btn-nav btn-sm btn-light login px-5 my-2 my-sm-0 rounded-pill" type="button">Login</a>
            @else
                <a href="{{route('Dashboard')}}" class="btn btn-nav btn-sm btn-light login px-5 my-2 my-sm-0 rounded-pill"
