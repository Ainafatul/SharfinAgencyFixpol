                    ...
                    <div class="row ">
                        ...
                        <div class="col-2 p-0">
                            <select class="custom-select" name="type">
                                <option @if(isset($_GET['type']) && $_GET['type'] == 'Beli') selected @endif value="Beli">Beli</option>
                                <option @if(isset($_GET['type']) && $_GET['type'] == 'Sewa') selected @endif value="Sewa">Sewa</option>
                            </select>
                        </div>
                        <div class="col-3 p-0">
                            <div class="form-input">
                        ...
                        <div class="col-4 p-0">
                            <select class="custom-select" name="km">
                                <option @if(isset($_GET['km']) && $_GET['km'] == 0) selected @endif value="0">Kamar Mandi</option>
                                <option @if(isset($_GET['km']) && $_GET['km'] == 99) selected @endif value="99">Semua KM</option>
                                <option @if(isset($_GET['km']) && $_GET['km'] == 1) selected @endif value="1">1 KM</option>
                                <option @if(isset($_GET['km']) && $_GET['km'] == 2) selected @endif value="2">2 KM</option>
                                <option @if(isset($_GET['km']) && $_GET['km'] == 3) selected @endif value="3">3 KM</option>
                                <option @if(isset($_GET['km']) && $_GET['km'] == 4) selected @endif value="4">4 KM</option>
                                <option @if(isset($_GET['km']) && $_GET['km'] == 5) selected @endif value="5">5 KM</option>
                                <option @if(isset($_GET['km']) && $_GET['km'] == 6) selected @endif value="6">6 KM</option>
                            </select>
                        </div>
                        <div class="col-4 p-0">
                            <select class="custom-select" name="kamar">
                                <option @if(isset($_GET['kamar']) && $_GET['kamar'] == 0) selected @endif  value="0">Kamar Tidur</option>
                                <option @if(isset($_GET['kamar']) && $_GET['kamar'] == 99) selected @endif  value="99">Semua KT</option>
                                <option @if(isset($_GET['kamar']) && $_GET['kamar'] == 1) selected @endif  value="1">1 KT</option>
                                <option @if(isset($_GET['kamar']) && $_GET['kamar'] == 2) selected @endif  value="2">2 KT</option>
                                <option @if(isset($_GET['kamar']) && $_GET['kamar'] == 3) selected @endif  value="3">3 KT</option>
                                <option @if(isset($_GET['kamar']) && $_GET['kamar'] == 4) selected @endif  value="4">4 KT</option>
                                <option @if(isset($_GET['kamar']) && $_GET['kamar'] == 5) selected @endif  value="5">5 KT</option>
                                <option @if(isset($_GET['kamar']) && $_GET['kamar'] == 6) selected @endif  value="6">6 KT</option>
                            </select>
                        </div>
                        <div class="col-4 p-0">
                            <select class="custom-select" name="land">
                                <option @if(isset($_GET['land']) && $_GET['land'] == 0) selected @endif  value="0">Luas Tanah</option>
                                <option @if(isset($_GET['land']) && $_GET['land'] == 99) selected @endif  value="99">Semua</option>
                                <option @if(isset($_GET['land']) && $_GET['land'] == 50) selected @endif  value="50">50 m2</option>
                                <option @if(isset($_GET['land']) && $_GET['land'] == 100) selected @endif  value="100">100 m2</option>
                                <option @if(isset($_GET['land']) && $_GET['land'] == 200) selected @endif  value="200">200 m2</option>
                                <option @if(isset($_GET['land']) && $_GET['land'] == 300) selected @endif  value="300">300 m2</option>
                                <option @if(isset($_GET['land']) && $_GET['land'] == 400) selected @endif  value="400">400 m2</option>
                                <option @if(isset($_GET['land']) && $_GET['land'] == 500) selected @endif  value="500">500 m2</option>
                                <option @if(isset($_GET['land']) && $_GET['land'] == 9999) selected @endif  value="9999">>500 m2</option>
                            </select>
                        </div>
                                ...
                                <a href="{{route('PropertyDetail',['id'=>$property->id])}}" class="item-jual">
                                    <div class="row ">
                                        <div class="col-4 my-auto">
                                            <img src="{{asset($property->main_image)}}" class="img-fluid img-jual d-block mx-auto w-100" alt="gambar 1" style="object-fit: cover">
                                        </div>
